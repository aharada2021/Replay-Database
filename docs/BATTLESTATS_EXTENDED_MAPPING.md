...
| **[167]** | `damage_deep_water_torps` | 深度魚雷ダメージ（パンアジア駆逐艦専用） | ✅ _meteor0090で検証済み |
...
通常魚雷と深度魚雷は**別々のインデックス**に保存されています:
...
print(f"    - 深度魚雷: {stats['damage_deep_water_torps']:,}")
print(f"  継続ダメージ:")
...
4. ✅ **パンアジア駆逐艦対応**: 深度魚雷ダメージを通常魚雷と区別して記録可能
